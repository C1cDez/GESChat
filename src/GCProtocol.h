...
GCPC GC_PROTOCOL_VERSION_MINOR = 1;
...
GCPC SENDING_PRIVATE_MESSAGE = 0x05;
GCPC FORWARDING_PRIVATE_MESSAGE = 0x06;
...
GCPI SENDING_PRIVATE_MESSAGE_LENGTH = 1 + USERNAME_LENGTH + MESSAGE_LENGTH;
